...
- 참고: WSL 환경의 `8082`는 `/home/lib2000/.openclaw/local-llm/ollama_qwen25_coder_bridge_8082.py`가 자동 점유하므로 InvestmentJournalApp Expo 표준 포트에서 제외합니다.
...
8001이 이미 꼬였거나 콘솔이 열리지 않으면 아래 명령으로 재시작과 확인을 한 번에 수행합니다.

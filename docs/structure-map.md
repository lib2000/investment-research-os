...
| `backend\research_os\recent_activity.py` | 최근 1주 자료용 출처별 compact helper, 공개 IR/SEC 추천 가산 가능 여부 판정 | `check_public_ir_sec_store.py`, `check_backend_module_health.py` |

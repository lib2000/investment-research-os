...
MARKET_JOURNAL_KEYWORD_ALIASES: dict[str, tuple[str, ...]] = {
    ...
    "communication services": ("통신", "미디어", "콘텐츠", "서비스업"),
    "media and content production": ("미디어", "콘텐츠", "엔터", "영상"),
    ...
    "cps technologies": ("소재", "반도체", "전자부품", "전력 반도체"),
    "infrastructure": ("인프라", "전력망", "배당"),
    "listed infrastructure fund": ("인프라", "배당", "금융"),
    "부동산": ("부동산", "리츠", "REIT", "배당"),
    "금융": ("금융", "은행", "증권"),
    "건설": ("건설", "주택", "인프라"),
    "통신": ("통신", "5G", "통신장비"),
    ...
    "식품": ("음식료", "식품", "소비"),
    "교육": ("교육", "에듀테크", "온라인 교육"),
    "소프트웨어 개발 및 공급업": ("소프트웨어", "SW", "AI", "클라우드", "보안"),
    "자료처리": ("데이터센터", "데이터", "AI", "소프트웨어"),
    "호스팅": ("데이터센터", "클라우드", "소프트웨어"),
    "네트워크 접근 제어": ("보안", "사이버 보안", "소프트웨어"),
    "edr": ("보안", "사이버 보안"),
    "의약품 제조업": ("바이오", "제약", "헬스케어", "백신"),
    "백혈병": ("바이오", "제약", "헬스케어"),
    "자연과학 및 공학 연구개발업": ("바이오", "제약", "헬스케어", "연구개발"),
    "특수 목적용 기계 제조업": ("기계", "장비", "반도체 장비", "로봇", "제조장비"),
    "일반 목적용 기계 제조업": ("기계", "장비", "제조장비", "로봇", "냉각"),
    "자동차 신품 부품 제조업": ("자동차", "모빌리티", "부품", "전기차"),
    "1차 철강 제조업": ("철강", "소재", "원자재"),
    "기초 화학물질 제조업": ("화학", "소재", "정밀화학", "전자재료"),
    "기타 화학제품 제조업": ("화학", "소재", "화장품", "소비재"),
    "신탁업 및 집합투자업": ("인프라", "리츠", "REIT", "배당", "금융"),
}

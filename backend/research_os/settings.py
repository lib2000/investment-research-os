...
class Settings(BaseModel):
    ...
    kiwoom_interest_endpoint_path: str = "/api/dostk/watchlist"
    ...
    telegram_deep_analysis_time: str = "07:00"
    ...
    def from_env(cls) -> "Settings":
        return cls(
            ...
            kiwoom_interest_endpoint_path=os.getenv("KIWOOM_INTEREST_ENDPOINT_PATH", "/api/dostk/watchlist"),
            ...
            telegram_deep_analysis_time=os.getenv("TELEGRAM_DEEP_ANALYSIS_TIME", "07:00"),
            ...
            regional_business_sources_timeout_seconds=float(
                os.getenv("REGIONAL_BUSINESS_SOURCES_TIMEOUT_SECONDS", "30")
            ),

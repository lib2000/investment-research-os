...
def recent_activity_item_key(item: dict) -> tuple:
    return recent_activity_navigation.recent_activity_item_key(item)


def recent_weekly_evidence_path_key(value: object) -> str:
    return recent_activity_navigation.recent_weekly_evidence_path_key(value)
...
def dedupe_recent_activity_items(items: list[dict]) -> list[dict]:
    return recent_activity_navigation.dedupe_recent_activity_items(items)

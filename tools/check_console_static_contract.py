...
REQUIRED_CSS_SNIPPETS = {
    ...
    "daily_recommendation_market_journal": ".daily-recommendation-market-journal",
...
REQUIRED_JS_SNIPPETS = {
    ...
    "daily_recommendation_top_panel_schedule": "매일 07:00 자동 실행",
    "daily_family_top_pick_schedule": "카드 자동 생성 ${escapeHtml(topPickSchedule)}",
    ...
    "daily_recommendation_market_journal_rows_helper": "dailyRecommendationMarketJournalRows",
    "daily_recommendation_market_journal_label": "시장일지 근거",
    ...
    "naver_research_compact_debug_payload": "naverResearchStatusDebugPayload",

...
FLOW_DEFINITIONS = {
    ...
    "market_signal_graph_pipeline": {
        ...
        "keywords": ["market_signal_graph_pipeline_contract", "firecrawl_ir_collector_v1", "firecrawl_earnings_collector_v1", "portfolio_signal_score_v1", "telegram_brief_sender_v1", "Market Signal Graph"],
        "expected_files": [
            ...
            "backend/research_os/firecrawl_earnings_collector.py",

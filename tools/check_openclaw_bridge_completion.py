...
def validate_openclaw_workspace(workspace: Path, bridge_status: dict | None = None) -> list[str]:
    ...
    required_items = [
        ...
        "register_openclaw_answer_capture_cycle_task.ps1",
        "check_openclaw_answer_capture_task_status.py --json",
        "check_openclaw_answer_capture_canary.py --json",
        ...
        "check_operational_schedule_status.py --json --allow-warnings",
...
def render_markdown_report(result: dict) -> str:
    ...
    for label in (
        ...
        "answer_samples",
        "actual_answer_audit",
        "answer_capture_cycle",
        "answer_capture_cycle_run",
        "answer_capture_cycle_register",
        "answer_capture_task_status",
        "answer_capture_canary",
        "actual_answer_capture",
        "pending_answer_collect",
        "actual_answer_capture_status",
        "wsl_refresh",
        "wsl_answer_context",
        "wsl_fresh_bootstrap",
        "backend_watchdog_status",

...
웹 미리보기 주소는 `http://localhost:8085`입니다. `start_mobile_web.ps1`은 프로젝트 루트 검증 후 `EXPO_PUBLIC_API_BASE_URL=http://127.0.0.1:8010`을 설정해서 Expo를 실행합니다.
...
개발 서버를 정리할 때는 아래 스크립트로 8010/8085 포트만 종료합니다.
